...
global Tmin Tmax Trange
global H1min H1max H1range
global H2min H2max H2range
global H3min H3max H3range
...
str = datestr(now);
savename = sprintf('SA34_%dx%d_%s%s%s', nplanets, nreruns, ...
    str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA34_1000x50_28Aug2017');
