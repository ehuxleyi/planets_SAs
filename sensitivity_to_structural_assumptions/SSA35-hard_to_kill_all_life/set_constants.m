...
Tmin = double(-70.0);         % minimum habitable temperature (lower limit of habitable range) (degrees C)
Tmax = double(150.0);          % maximum habitable temperature (upper limit of habitable range) (degrees C)
...
str = datestr(now);
savename = sprintf('SA35_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA35_I4_1000x50_22Apr2017');
