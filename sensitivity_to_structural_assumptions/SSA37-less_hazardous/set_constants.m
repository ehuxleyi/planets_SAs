...
fsd = 150.0;               % standard deviation of feedback strengths (degrees C per ky)
...
trendsd = 37.5;            % standard deviation of trends in dT/dt (degrees C per ky per By)
...
str = datestr(now);
savename = sprintf('SA37_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA37_I4_1000x50_18Jul2017');
...
maxavnumber_littlep = 10000;
maxavnumber_midp = 200;
maxavnumber_bigp = 0;
