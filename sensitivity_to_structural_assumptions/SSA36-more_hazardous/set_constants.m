...
fsd = 75.0;               % standard deviation of feedback strengths (degrees C per ky)
...
trendsd = 75;            % standard deviatio of trends in dT/dt (degrees C per ky per By)
...
str = datestr(now);
savename = sprintf('SA36_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA36_I4_10000x50_05May2017');
...
maxavnumber_littlep = 40000;
maxavnumber_midp = 800;
maxavnumber_bigp = 10;
