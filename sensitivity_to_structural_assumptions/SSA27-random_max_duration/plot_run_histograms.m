...
subplot(6,1,5);
% <<<<<<<<<< SPECIAL FOR THIS SA >>>>>>>>> replace max_duration with 3e6
bargap = ((3e6/1e6)/nbinsd);
edges = 0.0 : bargap : (3e6/1e6);
...
subplot(5,1,5);
% <<<<<<<<<< SPECIAL FOR THIS SA >>>>>>>>> replace max_duration with 3
thisgap = (3e6/1e6)/nbinsd;
x = (thisgap/2.0) : thisgap : ((3e6/1e6)-(thisgap/2.0));
