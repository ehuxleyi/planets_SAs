...
for ii = 1:nplanets
    ...
    for jj = 1:nreruns
        ...
        rdurations(jj) = runs(runnumber).length;
    ...
    fprintf('    average duration of habitability = %.4f ky\n', ...
        (round(sumduration)/nreruns));
    fprintf('    std deviation of duration of habitability = %.4f ky\n', ...
        std(rdurations(1:nreruns)));
    fprintf('    minimum duration of habitability = %.4f ky\n', ...
        min(rdurations(1:nreruns)));
    fprintf('    maximum duration of habitability = %.4f ky\n', ...
        max(rdurations(1:nreruns)));
