...
nnodes_max = 40;              % number of node points at which dT/dt needs to be specified
...
str = datestr(now);
savename = sprintf('SA5_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA5_I4_1000x50_07Mar2017');
