...
fsd = 50.0;               % standard deviation of feedback strengths (degrees C per ky)
...
str = datestr(now);
savename = sprintf('SA7_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA7_I4_1000x50_08Mar2017');
