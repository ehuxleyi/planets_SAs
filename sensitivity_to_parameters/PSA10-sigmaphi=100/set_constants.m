...
trendsd = 100.0;            % standard deviatio of trends in dT/dt (degrees C per ky per By)
...
str = datestr(now);
savename = sprintf('SA10_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA10_I4_1000x50_10Mar2017');
