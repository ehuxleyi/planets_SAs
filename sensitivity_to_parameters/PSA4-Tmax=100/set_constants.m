...
Tmax = double(100.0);          % maximum habitable temperature (upper limit of habitable range) (degrees C)
...
str = datestr(now);
savename = sprintf('SA4_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA4_I4_1000x50_03Apr2017');
