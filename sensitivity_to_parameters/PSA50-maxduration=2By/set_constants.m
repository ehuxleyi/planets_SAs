...
max_duration = 2e6;           % length of run: 3 billion y = 3 million ky
...
str = datestr(now);
savename = sprintf('SA50_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA50_I4_1000x50_20Mar2017');
