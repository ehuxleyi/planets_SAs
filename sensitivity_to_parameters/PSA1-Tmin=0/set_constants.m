...
Tmin = double(0.0);         % minimum habitable temperature (lower limit of habitable range) (degrees C)
...
str = datestr(now);
savename = sprintf('SA1_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA1_I4_1000x50_05Mar2017');
