...
% customise the resources required
%clustertoby.SubmitArguments = '-l walltime=1:00:00';
...
for jj = 1 : njobs
    ...
    % specify where the script files are
    %jt.AdditionalPaths={'/home/lrtt/planets/parallel_on_I4'};
    
    % display the cluster to check that my job is pending
    %clustertoby
