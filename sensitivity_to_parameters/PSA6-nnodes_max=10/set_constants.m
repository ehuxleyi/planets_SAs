...
nnodes_max = 10;              % number of node points at which dT/dt needs to be specified
...
str = datestr(now);
savename = sprintf('SA6_I4_%dx%d_%s%s%s', nplanets, nreruns, ...
   str(1:2), str(4:6), str(8:11));
% savename = sprintf('SA6_I4_1000x50_08Mar2017');
